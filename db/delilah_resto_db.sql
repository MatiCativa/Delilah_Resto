...
INSERT INTO `delilahdb`.`user` (`user_name`, `fullname`, `email`, `phone`, `adress`, `password`, `is_admin`) VALUES ('superUser', 'Matias', 'matias@mail', '123456789', 'calles sin nombre 123', 'root123', '1');
